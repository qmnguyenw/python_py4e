Minimum number of distinct elements present in a K-length subsequence in an
array



Given an array **A[]** consisting of **N** integers and an integer **K** , the
task is to count the minimum number of distinct elements present in a
subsequence of length **K** of the given array, **A**.

 **Examples:**

>  **Input:** A = {3, 1, 3, 2, 3, 4, 5, 4}, K = 4  
>  **Output:** 2  
>  **Explanation:** The subsequence of length 4 containing minimum number of
> distinct elements is {3, 3, 3, 4}, consisting of 2 distinct elements, i.e.
> {3, 4}.
>
>  **Input:** A = {3, 1, 3, 2, 3, 4, 5, 4}, K = 5  
>  **Output:** 2  
>  **Explanation:** The subsequence of length 5 containing minimum number of
> distinct elements is {3, 3, 3, 4, 4}, consisting of 2 distinct elements,
> i.e. {3, 4}.

Recommended: Please try your approach on _**_{IDE}_**_ first, before moving on
to the solution.

 **Naive Approach:** The simplest approach is to generate all subsequences of
length **K** **** and for each subsequence, find the number of distinct
elements present in them. Finally, print the minimum number of distinct
elements present.
 ...
 _ **Time Complexity:** O(K * NK)_  
 _ **Auxiliary Space:** O(N)_

 **Efficient Approach:** The above approach can be optimized using **Hashing**
