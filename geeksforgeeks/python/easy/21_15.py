...
using this toolkit. Let’s try to implement a message encryption-decryption
application according to the Vigenère cipher, which can encrypt the message
...
btnTotal = Button(f1, padx = 16, pady = 8, bd = 16, fg
= "black",
 ...
 **Output :**  
Encrypt Window –  
![](https://media.geeksforgeeks.org/wp-content/uploads/encrypt-1024x723.png)
...
Decrypt Window –  
![](https://media.geeksforgeeks.org/wp-content/uploads/decrypt-1024x811.png)  
