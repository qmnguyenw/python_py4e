...
just concerned about getting the values list and don’t care about keys. This
is yet another essential utility and solution to it should be known and
discussed. Let’s perform this task through certain methods.

 **Method #1 : Using loop +keys()**  
The first method that comes to mind to achieve this task is the use of loop to
access each key’s value and append it into a list and return it. This can be
one of method to perform this task.
