...
applications. Now, it’s up to the imagination or necessity of a developer,
what he/she wants to develop using this toolkit.
...
content/uploads/20210119132900/Screenshot266.png)

  

  

Let’s create a GUI based simple Age Calculator application that can calculate
...
if __name__ == "__main__" :
 ...
 givenDay = Label(gui, text = "Given Day", bg = "light
green")

 # Create a Given Month : label

 givenMonth = Label(gui, text = "Given Month", bg = "light
green")

 # Create a Given Year : label

 givenYear = Label(gui, text = "Given Year", bg = "light
green")
 ...
 rsltMonth = Label(gui, text = "Months", bg = "light
green")
 ...
 resultantAge = Button(gui, text = "Resultant Age", fg =
"Black", bg = "Red", command = calculateAge)

 # Create a Clear All Button and attached to clearAll function

 clearAllEntry = Button(gui, text = "Clear All", fg =
"Black", bg = "Red", command = clearAll)
...
https://media.geeksforgeeks.org/wp-
content/uploads/20210119132928/FreeOnlineScreenRecorderProject3.mp4
