...
to draw a snowman using the _turtle_ module. Snowman consists of circular
shaped snowballs of various sizes. The body of the snowman is made up of three
snowballs placed one over the other. Eyes, nose, and buttons are also
circular.

**Below are the steps of the above approach:**

  1. Import _turtle_ package. 
  2. Set screen with dimensions and color. 
  3. Create a _turtle_ object with color. 
  4. Create the Snowman by illustrating overlapping circles at particular positions.

 **Below is the Python program to illustrate a snowman using** _ **turtle**_
**module:**
