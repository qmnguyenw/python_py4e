...
has to be performed and then summation. This is quite a useful utility to have
knowledge about. Lets discuss certain ways in which this task can be
performed.
...
list as they arrive and cutting off new lists from them. The task of finding
...
**Method #2 : Usingitertools.chain() + zip() + sum()**  
...
to handle larger lists as this method is more efficient. The task of finding
summation is performed using sum().
