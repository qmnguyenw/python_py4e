...
require to perform index wise addition of tuple elements. This can get
...
summation logic is provided by generator expression.
...
res = tuple(tup_sum(x, y) for x, y in zip(test_tup1,
test_tup2))
