...
each of the nine 3×3 subgrids that compose the grid contain all of the digits
from 1 to 9.

We will be buiding the Sudoku Game in python using pygame library and automate
the game using backtracking algorithm.
...
def draw_box():
 ...
 pygame.draw.line(screen, (255, 0, 0), (x * dif-3, (y
+ i)*dif), (x * dif + dif + 3, (y + i)*dif),
7)
...
dif, dif + 1, dif + 1))
 ...
 text1 = font1.render(str(grid[i][j]), 1, (0, 0,
0))
...
(500, i * dif), thick)
 ...
 pygame.draw.line(screen, (0, 0, 0), (i * dif, 0), (i
* dif, 500), thick) 
...
def raise_error2():
 ...
 text1 = font1.render("Wrong !!! Not a valid Key", 1, (0,
0, 0))
...
def result():
 ...
 text1 = font1.render("FINISHED PRESS R or D", 1, (0,
0, 0))
