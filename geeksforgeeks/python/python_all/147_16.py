...
solves the problem of testing if a list contains series of odd or even
elements. Let’s discuss certain ways in which this problem can be solved.
...
res = any( sum(ele % 2 for ele in temps) % N
== 0 for temps in temp )
