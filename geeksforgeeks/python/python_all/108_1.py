...
There can be many situations in which one requires to find index wise XOR of
two different lists. This can have a possible applications in day-day
programming. Lets discuss various ways in which this task can be performed.

 **Method #1 : Naive Method**  
In this method, we simply run a loop and append to the new list the XOR of the
both list elements at similar index till we reach end of the smaller list.
