...
Strings to a separate list and thus forming a list of list. This can also
...
particular task as it counts the frequency of Strings in list and then we can
