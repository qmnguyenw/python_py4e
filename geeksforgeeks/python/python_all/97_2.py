...
and rear element retention and deletion of rest elements. It is a good utility
whose solution can be useful to have. Let’s discuss certain ways in which this
can be performed.

 **Method #1 : Using list slicing + del operator**  
The del operator can be clubbed with the slicing action to delete all but the
front and rear elements from a list to obtain a cropped version of list.
