...
perform tuple subtraction among all the tuples in list. This can have
...
comprehension is used to feed subtraction logic.
...
**Method #2 : Using list comprehension +zip() + operator.sub +
combinations()**  
The combinations of above methods can also solve this problem. In this, we
perform the task of subtraction using sub() and the like indexed elements are
linked using zip().
