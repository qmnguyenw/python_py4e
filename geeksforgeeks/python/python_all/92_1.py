...
to find the difference records between two lists that we receive. This is a
...
rather than running a loop to find the difference elements. In this, we just
...
res = [ele1 for ele1 in test_list1 for ele2 in test_list2
if ele1 == ele2]
...
**Method #2 : Usingset.intersection() \+ set operations**  
...
perform its intersection using intersection(). Then the result is computed by
taking uncommon element of result from first list.
