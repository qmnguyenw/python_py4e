...
require to perform index wise subtraction of tuple elements. This can get
...
we combine the elements across tuples using zip(). The iterations and
difference logic is provided by generator expression.
...
res = tuple(tup_diff(x, y) for x, y in zip(test_tup1,
test_tup2))
