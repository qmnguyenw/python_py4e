...
![longest-increasing-subsequence](https://media.geeksforgeeks.org/wp-
content/cdn-uploads/Longest-Increasing-Subsequence.png)
...
To find the LIS for a given array, we need to return max(L(i)) where 0 < i <
n.  
