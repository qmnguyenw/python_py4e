...
need to perform mathematical bitwise XOR operation across tuples. This problem
...
we perform the task of XOR using generator expression and mapping index of
...
**Method #2 : Usingmap() + xor**  
The combination of above functionalities can also perform this task. In this,
we perform the task of extending logic of XOR using xor and mapping is done by
map().
