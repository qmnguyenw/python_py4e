...
tkinter Python library is used to create the GUI. Two options are available to
play the game, **along with the system or with another player**.

A small winning strategy is used to play with the system. The system will try
to find the best place to put its naught or cross by which the system will win
or try to stop players to win.
...
board = [[" " for x in range(3)] for y in
range(3)]
...
def winner(b, l):
 ...
 return ((b[0][0] == l and b[0][1] == l
and b[0][2] == l) or

 (b[1][0] == l and b[1][1] == l and
b[1][2] == l) or

 (b[2][0] == l and b[2][1] == l and
b[2][2] == l) or

 (b[0][0] == l and b[1][0] == l and
b[2][0] == l) or

 (b[0][1] == l and b[1][1] == l and
b[2][1] == l) or

 (b[0][2] == l and b[1][2] == l and
b[2][2] == l) or

 (b[0][0] == l and b[1][1] == l and
b[2][2] == l) or

 (b[0][2] == l and b[1][1] == l and
b[2][0] == l))
...
def withplayer(game_board):
 ...
 l1 = Button(game_board, text = "Player 1 : X", width =
10)
...
def play():
 ...
 fg = "yellow", width = 500, font = 'summer', bd =
5)
