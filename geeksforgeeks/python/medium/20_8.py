 ...
 **Prerequisites :**Introduction to tkinter | Get the real time currency
exchange rate
...
Let’s create a GUI based simple Real-time currency convertor (Using Alpha
Vantage API) which can convert amounts from one currency to another currency.
...
if __name__ == "__main__" :
 ...
 headlabel = Label(root, text = 'welcome to Real Time Currency
Convertor', 
 ...
 CurrenyCode_list = ["INR", "USD", "CAD", "CNY",
"DKK", "EUR"]
 ...
 FromCurrency_option = OptionMenu(root, variable1,
*CurrenyCode_list)

 ToCurrency_option = OptionMenu(root, variable2,
*CurrenyCode_list)

 

 FromCurrency_option.grid(row = 2, column = 1, ipadx =
10)
 ...
 button1 = Button(root, text = "Convert", bg = "red", fg
= "black",
...
content/uploads/Screenshot-5151.png)  
![output2](https://media.geeksforgeeks.org/wp-
content/uploads/Screenshot-5150.png)  
