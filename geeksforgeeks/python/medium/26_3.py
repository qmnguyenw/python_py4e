...
itself, or multiple outbound links from one single page to another single
...
would have an initial value of 1. However, later versions of PageRank, and the
remainder of this section, assume a probability distribution between 0 and 1.
...
![PR\(A\) = PR\(B\) + PR\(C\) + PR\(D\).\\,](https://www.geeksforgeeks.org/wp-
content/ql-cache/quicklatex.com-a2401bb7437b322299f41491842a8793_l3.png)  
Suppose instead that page B had a link to pages C and A, page C had a link to
page A, and page D had links to all three pages. Thus, upon the first
iteration, page B would transfer half of its existing value, or 0.125, to page
A and the other half, or 0.125, to page C. Page C would transfer all of its
...
{PR\(D\)}{3}}.\\,](https://www.geeksforgeeks.org/wp-content/ql-
cache/quicklatex.com-b0a3c568f843dc28ece66f57330521d7_l3.png)  
...
{PR\(D\)}{L\(D\)}}.\\, ](https://www.geeksforgeeks.org/wp-content/ql-
cache/quicklatex.com-b1d1b955db3d554ce6e42dd87199bbe2_l3.png) In the general
case, the PageRank value for any page u can be expressed as:

![PR\(u\) = \\sum_{v \\in B_u}
\\frac{PR\(v\)}{L\(v\)}](https://www.geeksforgeeks.org/wp-content/ql-
cache/quicklatex.com-aafd3a0d9f8bb8325cf2b41a4a839bbf_l3.png),

i.e. the PageRank value for a page u is dependent on the PageRank values for
each page v contained in the set Bu (the set containing all pages linking to
page u), divided by the number L(v) of links from page v. The algorithm
...
weight=weight) == 0.0]
 ...
 danglesum = alpha * sum(xlast[n] for n in
dangling_nodes)
...
The above code is the function which has been implemented in the networkx
library.  
...
Below is the output, you would obtain on the IDLE after required
installations.
...
{0: 0.012774147598875784, 1: 0.013359655345577266, 2:
0.013157355731377924, 

3: 0.012142198569313045, 4: 0.013160014506830858, 5:
0.012973342862730735,

 6: 0.012166706783753325, 7: 0.011985935451513014, 8:
0.012973502696061718, 

9: 0.013374146193499381, 10: 0.01296354505412387, 11:
0.013163220326063332,
...
48: 0.02565482923824489, 49: 0.024939722913691394, 50:
0.02458271197701402,

 51: 0.024263128557312528, 52: 0.023505217517258568, 53:
0.023724311872578157,

 54: 0.02312908947188023, 55: 0.02298716954828392, 56:
0.02270220663300396,
...
The above code has been run on IDLE(Python IDE of windows). You would need to
download the networkx library before you run this code. The part inside the
curly braces represent the output. It is almost similar as Ipython(for Ubuntu
users).
...
Thus, this way the centrality measure of Page Rank is calculated for the given
graph. This way we have covered 2 centrality measures. I would like to write
further on the various centrality measures used for the network analysis.

This article is contributed by **Jayant Bisht**. If you like GeeksforGeeks and
