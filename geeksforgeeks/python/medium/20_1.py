...
plotting graphs. Let’s see how to add a chartsheet in an excel sheet and plot
line chart on it, using realtime data.
...
on an chartsheet, firstly, create chart object of specific chart type( i.e
Line chart etc.). After creating chart objects, insert data in it and lastly,
add that chart object in the chartsheet object.

 **Code :** Adding the chartsheet in an excel sheet.  
For creating a worksheet that only holds a chart we are using
**add_chartsheet()** method of workbook object.
...
content/uploads/Screenshot-5242.png)  
![output1](https://media.geeksforgeeks.org/wp-
content/uploads/Screenshot-5241.png)
