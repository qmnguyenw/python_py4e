...
According to Indeed, Machine Learning Engineer Is The Best Job of 2019 with a
_344%_ growth and an average base salary of **$146,085** per year.

![Getting Started with Machine Learning](https://media.geeksforgeeks.org/wp-
content/cdn-uploads/20190911182502/How-to-start-learning-ML1.png)
...
Learning and also the path you can follow to eventually become a full-fledged
...
machines to learn a task from experience without programming them specifically
about that task. (In short, Machines learn automatically without human hand
holding!!!) This process starts with feeding them good quality data and then
training the machines by building various machine learning models using the
data and different algorithms. The choice of algorithms depends on what type
...
data scientist. If you are more focused on application heavy machine learning,
then you will not be that heavily focused on maths as there are many common
libraries available. But if you want to focus on R&D; in Machine Learning,
then mastery of Linear Algebra and Multivariate Calculus is very important as
you will have to implement many ML algorithms from scratch.

#### (b) Learn Statistics

Data plays a huge role in Machine Learning. In fact, around 80% of your time
as an ML expert will be spent collecting and cleaning data. And statistics is
a field that handles the collection, analysis, and presentation of data. So it
is no surprise that you need to learn it!!!  
...
then move on to the more complicated stuff. Some of the basic concepts in ML
are:
...
There are various online and offline resources (both free and paid!) that can
be used to learn Machine Learning. Some of these are provided here:
...
After you have understood the basics of Machine Learning, you can move on to
the crazy part!!! Competitions! These will basically make you even more
proficient in ML by combining your mostly theoretical knowledge with practical
implementation. Some of the basic competitions that you can start with on
Kaggle that will help you build confidence are given here:
...
…Congratulations!!! You are well on your way to becoming a full-fledged
Machine Learning Engineer and you can continue enhancing your skills by
working on more and more challenges and eventually creating more and more
creative and difficult Machine Learning projects.
