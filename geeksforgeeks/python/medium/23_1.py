 ...
 **Prerequisites :** Introduction to Tkinter | Using google distance matrix
API
...
Let’s create a GUI based Distance-Time calculator using Python Tkinter module,
which can tell distance between two city / location and time taken in
...
def result(source, destination, travel_modes):
 ...
 '&mode; = transit&transit;_mode = train' + \
...
if __name__ == "__main__" :
 ...
 headlabel = Label(root, text = 'welcome to distance time
calculator',
 ...
 destination_field.grid(row = 2, column = 1, ipadx
="100")
...
content/uploads/Screenshot-1441.png)
